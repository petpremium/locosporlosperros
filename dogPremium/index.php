...
<div id="home-wrap">
	<div id="home">
		...
		<div id="introduccion">
			<div class="container">
				<p class="main-text">¡Dog Premium es tu comunidad especialmente creada para el cuidado de tu mejor amigo! Sabemos que quieres lo mejor para él, por eso tenemos mucha información útil para cuidarlo como se merece.</p>
			</div>
		</div>
		<!-- Novedades -->
		<div id="novedades">
